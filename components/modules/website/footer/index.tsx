          ...
          <div className="flex-col gap-12">
            <div className="grid grid-cols-1 lg:grid-cols-4 text-slate-400 text-xl">
              <ul className="flex flex-col gap-4">
                ...
                <li className="flex gap-4">
                  <PhoneCall /> +91 60052 00XXX
                </li>
                <li className="flex gap-4">
                  <Mail /> Anagale@anag.store
                </li>
                <li className="flex gap-4">
                  <MapPin /> 38 Aggarwal Street. Jaipur, India 302019
                </li>
              </ul>
              <ul className="flex flex-col gap-4">
                <li className="my-10">
            ...
            <div className="flex my-10 flex-wrap lg:flex-nowrap gap-8 justify-between">
              ...
              <div className="inline-flex gap-4 items-center text-slate-300 text-sm">
                @2024 Anagale All rights reserved | Developed by Anag
                <Link href="https://bento.me/anag" passHref>
                  <Button
                    className="ml-4 hover:bg-primary-500 hover:text-white"
                    variant="outline"
                    size="sm"
                  >
                    <p className="text-black hover:text-white">Check Developer's Profile!</p>
                  </Button>
                </Link>
                <Link href="https://github.com/Anag0710" passHref>
                  <Button
                    className="ml-4 hover:bg-primary-500 hover:text-white"
                    variant="outline"
                    size="sm"
                  >
                    <p className="text-black hover:text-white flex gap-2">
                      <Github/> Developer's GitHub
                    </p>
                  </Button>
                </Link>
              </div>
